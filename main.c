...
int main() {
    ...
    bool in_loop = true;
    char array[54][30] = {
                            "mx_printchar.c", "mx_print_unicode.c", "mx_printstr.c", "mx_print_strarr.c", "mx_printint.c", "mx_pow.c", "mx_sqrt.c",
    ...
    while (in_loop) {
        ...
        if (number_of_function == -1) {
            ...
            mx_printstr("\n\n");
            system("leaks -q untitled");
        } else if (number_of_function == 23) { // strcmp
            char str1[6] = "hello";
            char str2[6] = "HELLO";
            mx_printstr("\nfirst string is : ");
            mx_printstr(str1);
            ...
            mx_printstr("\n\n");
            system("leaks -q untitled");
        } else if (number_of_function == 24) { // strcat
            char str1[6] = "hello";
            char str2[10] = " brother";
            mx_printstr("\nfirst string is : ");
            mx_printstr(str1);
            mx_printchar('\n');
            mx_printstr("second string is : ");
            ...
            mx_printstr("\n\n");
            system("leaks -q untitled");
        } else if (number_of_function == 25) { // strstr
            ...
            mx_printstr("\n\n");
            system("leaks -q untitled");
        } else if (number_of_function == 26) { // get_substr_index
            char haystack[20] = "TutorialsPoint.com";
            char needle[10] = "Point";
            int res;
            ...
            mx_printstr("\n\n");
            system("leaks -q untitled");
        } else if (number_of_function == 27) { // count_substr
            char *haystack = "TutorialsPointPointPoint";
            char *needle = "Point";
            int res;
            ...
            mx_printstr("\n\n");
            system("leaks -q untitled");
        } else if (number_of_function == 28) { // count_words
            char *haystack = "Tutorials Point Point Point";
            int res;
            ...
            mx_printstr("\n\n");
            system("leaks -q untitled");
        } else if (number_of_function == 30) { // strtrim
            ...
            mx_printstr("\n\n");
            system("leaks -q untitled");
        } else if (number_of_function == 31) { // del_extra_spaces
            char *s1 = "    \t hello     my   dear \tfriend !   \t \n";
            mx_printstr(s1);
            mx_printchar('\n');
            ...
            mx_printstr("\n\n");
            system("leaks -q untitled");
        } else if (number_of_function == 32) { // strsplit
            ...
            mx_printstr("\n");
            system("leaks -q untitled");
        } else if (number_of_function == 33) { // strjoin
            char *str1 = "this";
            char *str2 = "dodge ";
            mx_printstr("\n");
            ...
            mx_printstr("\n\n");
            system("leaks -q untitled");
        } else if (number_of_function == 34) { // file_to_str
            ...
            mx_printstr("\n\n");
            system("leaks -q untitled");
        } else if (number_of_function == 36) { // memset
            char *str = mx_strnew(5);
            for (int i = 0; i < 5; ++i) {
                str[i] = 'r';
            }
            ...
            mx_printstr("\n\n");
            system("leaks -q untitled");
        } else if (number_of_function == 37) { // memcpy
            ...
            mx_printstr("\n\n");
            system("leaks -q untitled");
        } else if (number_of_function == 38) { // memccpy
            const char src[50] = "1234567";
            char dest[50] = "http://www.tutorialspoint.com";
            mx_printstr("\n");
            mx_printstr("str before : ");
            ...
            mx_printstr("\n\n");
            system("leaks -q untitled");
        } else if (number_of_function == 41) { // memrchr
            const char str[] = "http://www.tutorialspoint.com";
            const char ch = '.';
            char *ret;
            ...
            mx_printstr("\n\n");
            system("leaks -q untitled");
        } else if (number_of_function == 42) { // memmem
            ...
            mx_printstr("\n\n");
            system("leaks -q untitled");
        } else if (number_of_function == 43) { // memmove
            char d[] = "12345";
            char s[] = "linux";
            mx_printstr("\n");
            ...
            mx_printstr("\n\n");
            system("leaks -q untitled");
        }   else if (number_of_function == 44) { // realloc
            ...
            mx_printstr("\n\n");
            system("leaks -q untitled");
        } else if (number_of_function == 45) { // create_node
            t_list *head = mx_create_node("node created");
            mx_printstr("\n");
            mx_printstr(head->data);
            mx_printstr("\n\n");
            system("leaks -q untitled");
        } else if (number_of_function == 46) { // push_front
        ...
        } else if (number_of_function == 47) { // push_back
            t_list *first = mx_create_node("1");
        ...
        } else if (number_of_function == 48) { // pop_front
            char *s1 = mx_strnew(1);
            char *s2 = mx_strnew(1);
            char *s3 = mx_strnew(1);
            char *s4 = mx_strnew(1);
        ...
        } else if (number_of_function == 49) { // pop_back
            char *s1 = mx_strnew(1);
            char *s2 = mx_strnew(1);
            char *s3 = mx_strnew(1);
            char *s4 = mx_strnew(1);
        ...
        } else if (number_of_function == 50) { // list_size
            t_list *first = mx_create_node("1");
            mx_push_back(&first, "2");
            mx_push_back(&first, "3");
            mx_push_back(&first, "4");
